...
class AnketaForm(forms.Form):
    ...
    lastname = forms.CharField(label='Фамилия ', min_length=2, max_length=100)
    otchestvo = forms.CharField(label='Отчество ', min_length=2, max_length=100)
    avto = forms.CharField(label='Ваша лайба ', min_length=2, max_length=100)
